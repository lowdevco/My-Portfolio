  ...
  const categories = [
    {
      title: "Frontend",
      skills: [
        { name: "React", icon: <FaReact className="w-5 h-5" aria-hidden="true" /> },
        { name: "JavaScript", icon: <SiJavascript className="w-5 h-5" aria-hidden="true" /> },
        { name: "Tailwind CSS", icon: <SiTailwindcss className="w-5 h-5" aria-hidden="true" /> },
        { name: "Bootstrap", icon: <SiBootstrap className="w-5 h-5" aria-hidden="true" /> },
        { name: "jQuery", icon: <SiJquery className="w-5 h-5" aria-hidden="true" /> },
      ],
    },
    {
      title: "Backend & Database",
      skills: [
        { name: "Python", icon: <SiPython className="w-5 h-5" aria-hidden="true" /> },
        { name: "Django", icon: <SiDjango className="w-5 h-5" aria-hidden="true" /> },
        { name: "Node.js", icon: <DiNodejsSmall className="w-6 h-6" aria-hidden="true" /> },
        { name: "MySQL", icon: <SiMysql className="w-5 h-5" aria-hidden="true" /> },
        { name: "SQLite", icon: <SiSqlite className="w-5 h-5" aria-hidden="true" /> },
      ],
    },
    {
      title: "Developer Tools",
      skills: [
        { name: "Git", icon: <SiGit className="w-5 h-5" aria-hidden="true" /> },
        { name: "VS Code", icon: <VscVscode className="w-5 h-5" aria-hidden="true" /> },
        { name: "Postman", icon: <SiPostman className="w-5 h-5" aria-hidden="true" /> },
        { name: "Figma", icon: <SiFigma className="w-5 h-5" aria-hidden="true" /> },
      ],
    },
  ];
